...
- (nullable instancetype)initWithCoder:(NSCoder *)aDecoder {
  ...
  OIDServiceDiscovery *discoveryDocument = [aDecoder decodeObjectOfClasses:[NSSet setWithObjects:[OIDServiceDiscovery class], [NSArray class], nil] forKey:kDiscoveryDocumentKey];
